...
/* let id = 'http://127.0.0.1/1548/page'.split('/')[3]; */
...
const getDetail = function(id){
  ...
  let url = 'http://127.0.0.1:5000/'+id+'/root-data';
  $.get(url,dataT,(res)=>{
...
const tooltip2 = new G6.Tooltip({
  ...
  const getExistData = function(id){
    ...
    let url = 'http://127.0.0.1:5000/'+id+'/ori-connections';
    $.get(url,id,(res)=>{
  ...
  const getPredictData = function(id){
    let url = 'http://127.0.0.1:5000/'+id+'/predict-connections';
